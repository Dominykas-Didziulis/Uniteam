...
<html lang="en-us">
  <head>
    ...
    <link rel="shortcut icon" href="STemplateData/favicon.ico">
    <link rel="stylesheet" href="STemplateData/style.css">
  ...
  <body>
    <div id="unity-container" class="unity-desktop">
      ...
      <div id="unity-footer">
        ...
        <div id="unity-build-title">Quiz Demo</div>
      </div>
    </div>
    <script>
      ...
      var buildUrl = "SBuild";
      var loaderUrl = buildUrl + "/sit_Build.loader.js";
      var config = {
        dataUrl: buildUrl + "/sit_Build.data",
        frameworkUrl: buildUrl + "/sit_Build.framework.js",
        codeUrl: buildUrl + "/sit_Build.wasm",
        streamingAssetsUrl: "StreamingAssets",
        companyName: "DefaultCompany",
        productName: "Sitdowns",
        productVersion: "1.0",
